    ...
    <div>
        <div class="d-flex flex-column flex-root" id="kt_app_page">
					...
					<div class="container-xxl">
						...
						<div class="d-flex align-items-center">
							...
							<div class="d-flex align-items-center me-8">
								...
								<!--begin::Logo image-->
								<a href="landing.html">
									<img alt="Logo" src="assets/media/logos/default.svg" class="h-25px" />
								</a>
								<!--end::Logo image-->
							</div>
							<!--end::Logo-->
							...
							<div class="d-lg-block" id="kt_header_nav_wrapper">
								<div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
									<!--begin::Menu-->
									<div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-dark menu-state-title-primary nav nav-flush fs-3 fw-bold" id="kt_landing_menu">
										<!--begin::Menu item-->
										<div class="menu-item">
											<!--begin::Menu link-->
										...
										<div class="menu-item">
											<!--begin::Menu link-->
											<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#fatures" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Fatures</a>
											<!--end::Menu link-->
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										...
										<div class="menu-item">
											<!--begin::Menu link-->
											<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#projects" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Projects</a>
											<!--end::Menu link-->
										</div>
										<!--end::Menu item-->
									</div>
							...
							<div class="flex-equal text-end ms-1 position-relative z-index-2">
								<a href="index.html" class="btn btn-danger">Try Demo</a>
							</div>
							<!--end::Toolbar-->
						</div>
						<!--end::Wrapper-->
							...
							<div class="col-sm-6">
								...
								<div class="pe-5">
									...
									<div class="d-flex flex-shrink-0 me-5">
										<!--begin::Link-->
										<a href="index.html" class="btn btn-primary flex-shrink-0 fw-bolder me-2 me-md-4 my-1">Create a Team</a>
										<!--end::Link-->
										<!--begin::Link-->
										<a href="pages/user-profile/projects.html" class="btn btn-white btn-color-gray-700 flex-shrink-0 my-1 fw-bolder btn-active-light-primary">Take a Tour</a>
										<!--end::Link-->
									</div>
									<!--end::Action-->
								</div>
					...
					<div class="row gy-10 mb-md-20">
						...
						<div class="col-sm-4">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<div class="d-flex flex-center mb-5">
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bolder text-dark">Create Your Team</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-bold fs-6 fs-lg-4 text-gray-700">Hire best developers by using
								<br />our HR tool to get starte
								<br />with your project</div>
								<!--end::Description-->
							</div>
							<!--end::Story-->
						</div>
						...
						<div class="col-sm-4">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-bold fs-6 fs-lg-4 text-gray-700">We take care of your app deployment
								<br />within our cloud services
								<br />hassle free, fast</div>
								<!--end::Description-->
							</div>
							<!--end::Story-->
						</div>
			...
			<div class="mb-0">
				...
				<div class="container-xxl">
					<!--begin::Title-->
					<h3 class="fs-lg-2tx fs-2x text-dark text-center mb-7 mb-lg-16 lh-base position-relative z-index-2" id="fatures" data-kt-scroll-offset="{default: 100, lg: 150}">Timely Connection to Latest Updates
					<br />in All Frameworks and Tools</h3>
					<!--end::Title-->
					<!--begin::Row-->
					...
					<div class="card border-0 bg-primary overflow-hidden mb-lg-15 z-index-2">
						...
						<div class="card-body text-center my-9">
							<!--begin::Title-->
							<div class="fs-lg-3tx fs-2x fw-bolder text-white pt-lg-20 mt-lg-4 mb-lg-20 mb-10 pb-2 position-relative z-index-2">
								<span class="d-block mb-8">Make Great Visual Punchlines</span>
								<span class="d-block lh-0">Topic That Interests YOU</span>
							</div>
							<!--end::Title-->
							<!--begin::Action-->
							<div class="mb-lg-20 position-relative z-index-2">
								<a href="pages/blog/post.html" class="btn btn-danger btn-lg h-55px pt-5">Get Started Now</a>
							</div>
							<!--end::Action-->
							...
							<div class="d-flex flex-column flex-md-row">
								...
								<div class="pe-7">
									...
									<div class="d-flex align-items-center">
										...
										<div class="flex-grow-1">
											<a href="pages/user-profile/overview.html" class="text-dark fw-bolder text-hover-primary fs-6">Paul Miles</a>
											<span class="text-gray-400 d-block fw-bold">Development Lead</span>
										</div>
										<!--end::User-->
									</div>
									<!--end::Item-->
								...
								<div class="pe-7">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::User-->
										<div class="flex-grow-1">
											<a href="pages/user-profile/overview.html" class="text-dark fw-bolder text-hover-primary fs-6">Janya Clebert</a>
											<span class="text-gray-400 d-block fw-bold">Project Manager</span>
										</div>
										<!--end::User-->
									</div>
									<!--end::Item-->
								...
								<div class="">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::User-->
										<div class="flex-grow-1">
											<a href="pages/user-profile/overview.html" class="text-dark fw-bolder text-hover-primary fs-6">Steave Brown</a>
											<span class="text-gray-400 d-block fw-bold">HTML, JS, ReactJS</span>
										</div>
										<!--end::User-->
									</div>
									<!--end::Item-->
						...
						<div class="d-flex flex-column container pt-lg-20">
							...
							<div class="text-center" id="kt_pricing">
								...
								<div class="rounded-1 d-inline-flex p-1 mb-10" data-kt-buttons="true" style="border: 1px dashed rgba(64, 61, 56, 0.2);">
									<a href="#" class="btn btn-color-dark btn-sm btn-active btn-active-primary rounded-1 fw-bolder py-2 fs-6 px-5 me-2 active" data-kt-plan="month">Monthly</a>
									<a href="#" class="btn btn-color-dark btn-sm btn-active btn-active-primary rounded-1 fw-bolder fs-5 py-2 px-5" data-kt-plan="annual">Annual</a>
								</div>
								<!--end::Nav group-->
								<!--begin::Row-->
											...
											<div class="w-100 d-flex flex-column flex-center rounded-3 bg-gray-100 py-15 px-10">
												...
												<div class="w-100 mb-10">
													...
													<div class="d-flex flex-stack mb-5">
														<span class="fw-bold fs-6 text-gray-600 text-start pe-3">Up to 10 Active Users</span>
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-bold fs-6 text-gray-600 text-start pe-3">Up to 30 Project Integrations</span>
														<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
														<span class="svg-icon svg-icon-2 svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-bold fs-6 text-gray-600">Keen Analytics Platform</span>
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-bold fs-6 text-gray-600">Targets Timelines &amp; Files</span>
														<!--begin::Svg Icon | path: icons/duotune/general/gen040.svg-->
														<span class="svg-icon svg-icon-2 svg-icon-gray-400">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
													...
													<div class="d-flex flex-stack">
														<span class="fw-bold fs-6 text-gray-600">Unlimited Projects</span>
														<!--begin::Svg Icon | path: icons/duotune/general/gen040.svg-->
														<span class="svg-icon svg-icon-2 svg-icon-gray-400">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
												...
												<!--end::Features-->
												<!--begin::Select-->
												<a href="#" class="btn btn-primary btn-sm fw-bolder rounded-1">Select</a>
												<!--end::Select-->
											</div>
											<!--end::Option-->
										</div>
									...
									<div class="col-xl-4">
										<div class="d-flex h-100 align-items-center">
											...
											<div class="w-100 d-flex flex-column flex-center rounded bg-danger py-20 px-10">
												...
												<!--end::Features-->
												<!--begin::Select-->
												<a href="#" class="btn btn-color-primary btn-sm fw-bolder btn-white rounded-1">Select</a>
												<!--end::Select-->
											</div>
											<!--end::Option-->
										</div>
										...
										<div class="d-flex h-100 align-items-center">
											...
											<div class="w-100 d-flex flex-column flex-center rounded-3 bg-gray-100 py-15 px-10">
												...
												<div class="w-100 mb-10">
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-bold fs-6 text-gray-600 text-start pe-3">Keen Analytics Platform</span>
														<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
														<span class="svg-icon svg-icon-2 svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-bold fs-6 text-gray-600 text-start pe-3">Targets Timelines &amp; Files</span>
														<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
														<span class="svg-icon svg-icon-2 svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack">
														<span class="fw-bold fs-6 text-gray-600 text-start pe-3">Unlimited Projects</span>
														<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
														<span class="svg-icon svg-icon-2 svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
			...
			<div class="pt-lg-20 mb-lg-20 mb-12 d-flex">
				...
				<div class="container-xxl position-relative">
					...
					<div class="me-5">
						<!--begin::Content-->
						<div class="mb-11 position-relative z-index-3">
							<!--begin::Title-->
							<h3 class="fs-lg-2tx fs-2x fw-bolder text-gray-900 fw-bolder mb-7 lh-base">All-In-One Solution To Design,
							<br />Build and Deploy Your App Today
							<br /></h3>
							<!--end::Title-->
							<!--begin::Text-->
						...
						<!--end::Content-->
						<!--begin::Item-->
						<div class="d-flex mb-lg-15 position-relative z-index-3">
							<!--begin::Item-->
							<div class="me-lg-19 me-7">
								<div class="text-dark fw-bold fs-1">
								<span class="m-0" data-kt-countup="true" data-kt-countup-value="100">0</span>%</div>
								<span class="text-gray-700 d-block fw-bold fs-4">Satisfication</span>
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="me-lg-19 me-7">
								<div class="text-dark fw-bold fs-1">
								<span class="m-0" data-kt-countup="true" data-kt-countup-value="124">0</span>K</div>
								<span class="text-gray-700 d-block fw-bold fs-4">Customers</span>
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="me-lg-19 me-7">
								<div class="text-dark fw-bold fs-1">
								<span class="m-0" data-kt-countup="true" data-kt-countup-value="24" data-kt-countup-prefix="$">0</span>K</div>
								<span class="text-gray-700 d-block fw-bold fs-4">Transactions</span>
							</div>
							<!--end::Item-->
						</div>
						<!--end::Item-->
			...
			<div class="mb-lg-n15 position-relative z-index-2">
				<!--begin::Container-->
				<div class="container mb-lg-13">
					<!--begin::Card-->
					<div class="card border-0 bg-gray-100">
						<!--begin::Card body-->
						<div class="card-body p-lg-20">
							<!--begin::Heading-->
							<div class="text-center pt-lg-5 mb-7">
								<!--begin::Title-->
								<h3 class="fs-2tx text-dark mb-5" id="projects" data-kt-scroll-offset="{default: 100, lg: 150}">Good Projects</h3>
								<!--end::Title-->
							</div>
							<!--end::Heading-->
							<!--begin::Tabs wrapper-->
							<div class="d-flex flex-center mb-5 mb-lg-12">
								<!--begin::Tabs-->
								<ul class="nav border-transparent flex-center fs-4 fw-bold">
									<li class="nav-item">
										<a class="nav-link text-gray-700 text-active-primary px-3 px-lg-6 active" href="#" data-bs-toggle="tab" data-bs-target="#kt_landing_projects_items">All Items</a>
									</li>
									<li class="nav-item">
										<a class="nav-link text-gray-700 text-active-primary px-3 px-lg-6" href="#" data-bs-toggle="tab" data-bs-target="#kt_landing_projects_web_design">Web Design</a>
									</li>
									<li class="nav-item">
										<a class="nav-link text-gray-700 text-active-primary px-3 px-lg-6" href="#" data-bs-toggle="tab" data-bs-target="#kt_landing_projects_mobile_apps">Mobile Apps</a>
									</li>
									<li class="nav-item">
										<a class="nav-link text-gray-700 text-active-primary px-3 px-lg-6" href="#" data-bs-toggle="tab" data-bs-target="#kt_landing_projects_development">Development</a>
									</li>
								</ul>
								<!--end::Tabs-->
							</div>
							<!--end::Tabs wrapper-->
							<!--begin::Tabs content-->
							<div class="tab-content px-lg-5 mb-lg-5">
								<!--begin::Tab pane-->
								<div class="tab-pane fade show active" id="kt_landing_projects_items">
									<!--begin::Row-->
								...
								<div class="tab-pane fade" id="kt_landing_projects_web_design">
									...
									<div class="row g-5 g-lg-10">
										...
										<div class="col-lg-6">
											<!--begin::Row-->
											<div class="row g-10 mb-5 mb-lg-10">
												<!--begin::Col-->
												<div class="col-lg-6">
													<!--begin::Item-->
							...
							<div class="col-lg-6">
								...
								<div class="d-flex justify-content-center">
									...
									<div class="d-flex fw-bold flex-column me-20">
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="documentation/getting-started/changelog.html" class="text-gray-700 text-hover-primary fs-5 mb-6">Changelog</a>
										<!--end::Link-->
										<!--begin::Link-->
					...
					<div class="container">
						...
						<div class="d-flex flex-column flex-md-row flex-stack py-8">
							...
							<div class="d-flex align-items-center order-2 order-md-1">
								<!--begin::Logo-->
								<a href="landing.html">
									<img alt="Logo" src="assets/media/logos/default.svg" class="h-15px h-md-25px" />
								</a>
								<!--end::Logo image-->
								<!--begin::Logo image-->
